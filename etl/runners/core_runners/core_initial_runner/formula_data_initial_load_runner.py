...
class FormulaDataCoreInitialExtractRunner(CoreExtractRunnerTemplate):
    ...
    def source_path(self) -> str:
        return 'staging.stg_formula'

    def destination_table_name(self) -> str:
        return 'fact_formula_feed'

    def load_type(self):
        return 'initial'

    def get_sql(self) -> str:
        return load_sql("core/initial/facts/fact_formula_feed_initial.sql")
